        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <g:form action="confirm" controller="reservation" name="confirmation-form" class="form" >
                    <input type="hidden" name="checkIn" value="${formatDate(format: 'MM/dd/yyyy', date: availabilityCmd.checkIn)}">
                    <input type="hidden" name="checkOut" value="${formatDate(format: 'MM/dd/yyyy', date: availabilityCmd.checkOut)}">
                    <input type="hidden" name="guests" value="${availabilityCmd.guests}">
